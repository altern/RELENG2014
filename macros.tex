...
%\newcommand{\RQ}[1]{\MyParagraph{Research Question:\xspace#1}}

\newcommand{\RQOne}{\textbf{RQ1:} How does OSS vs. proprietary development affect version numbers?\xspace}
\newcommand{\RQTwo}{\textbf{RQ2:} How does project size affect version numbers?\xspace}
\newcommand{\RQThree}{\textbf{RQ3:} How does the age of a project affect version numbers?\xspace}
\newcommand{\RQFour}{\textbf{RQ4:} How do development tools compare to other applications  in version numbers?\xspace}
\newcommand{\RQFive}{\textbf{RQ5:} How do SDKs compare to other applications in version numbers?\space}
\newcommand{\RQSix}{\textbf{RQ6:} How does using SVN vs. git as a version control system affect version numbers\xspace}
