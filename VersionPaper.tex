...
Additionally, Apache Portable Runtime project consider versions that contain a zero as the first version compound as a special case where incrementing version numbers does not communicate consistent information about the changes in the project \cite{ApacheVersionNumbering}.
...
\TODO{1. check Aggregate Metrics, 2. Analysis, 3.Implications, 4. Related Work. check 5. Aggregated Inconsistancy Metric}
