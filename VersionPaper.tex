...
Second property that defines number of possible choices for new version numbers is \textbf{number of "locked in" versions}. Software team has an option to release new update of older software version to support users that use older versions of software. For example, number of choices for assigning new version number for the list of existing versions 1.0, 1.1, 1.2, 2.0, 2.1, 3.0 would be 3 (1.3, 2.2, 3.1). In this case software team has choice to release updates both for latest version 3.0 and for older versions 1.2 and 2.1. Note that choice of selecting version 2.0 for release following 1.2 is unavailable because version 2.0 already exists. Choice of selecting version 3.0 for release following 2.1 is also unavailable because version 3.0 already exists. In this case we consider set of versions 1.x (1.0, 1.1, 1.2) and 2.x (2.0, 2.1) to be "locked in" because one of the choices for new version numbers is unavailable.
